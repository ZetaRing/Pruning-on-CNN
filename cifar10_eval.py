...
tf.app.flags.DEFINE_string('eval_dir', '/home/wind/Desktop/cifarReportWeek1/cifar10_exp/cifar10_eval',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('eval_data', 'test',
                           """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', '/home/wind/Desktop/cifarReportWeek1/cifar10_exp/cifar10_train',
...
def eval_once(saver, summary_writer, top_k_op, summary_op):
  ...
  return precision,(nonzero_num/total_num)
...
def evaluate():
  ...
  with tf.Graph().as_default() as g:
    ...
    while True:
      precision,compress = eval_once(saver, summary_writer, top_k_op, summary_op)
      if FLAGS.run_once:
        break
      time.sleep(FLAGS.eval_interval_secs)
    return precision,compress
